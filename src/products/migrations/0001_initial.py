    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_type', models.CharField(choices=[('Short Dress', 'Short Dress'), ('Abaya', 'Abaya'), ('Pajama', 'Pajama')], max_length=50, verbose_name='Product Type')),
                ('product_name_english', models.CharField(max_length=150, verbose_name='Name English')),
                ('product_name_arabic', models.CharField(max_length=150, verbose_name='Name Arabic')),
                ...
                ('product_discount_start_enddate', models.DateField(verbose_name='Discount End Date')),
                ('product_variant', models.CharField(choices=[('None', 'None'), ('Size', 'Size'), ('Color', 'Color'), ('Size-Color', 'Size-Color')], default='None', max_length=10, verbose_name='Product Variant')),
                ('product_slug', models.SlugField(unique=True, verbose_name='Slug')),
                ('product_status', models.BooleanField(choices=[('True', 'Available'), ('False', 'unavailable')], verbose_name='Product Status')),
